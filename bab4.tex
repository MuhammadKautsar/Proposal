...
% Aturan bisnis (business rule) adalah sebuah pernyataan yang menjelaskan kebijakan bisnis atau keputusan prosedur. Beberapa bahasa pemrograman menjalankan aturan-aturan bisnis secara bersamaan menjadi algoritma yang sangat kompleks.
...
\begin{enumerate}
	...
	% \item Penjual harus memiliki akun agar bisa menjual produknya di aplikasi.
	...
	% \item Penjual tidak dapat membatalkan pesanan tanpa menuliskan alasan
	% \item penjual tidak boleh mengupload gambar produk yang tidak sesuai dengan gambar aslinya
	...
	% \item Hanya pembeli yang sudah mempunyai akun yang dapat memesan produk.
	% \item Pembayaran hanya bisa dilakukan secara tunai (\textit{cash on delivery}).
...
\subsection{\textit{Deployment Diagram}}
	...
	% diagram yang menjelaskan secara detail bagaimana kompenen disebar atau di dideploy ke dalam infrastruktur sebuah sistem.
	
	% diagram untuk memvisualisasikan hubungan antara software dan hardware. 

	% Deployment Diagram merupakan diagram yang digunakan untuk menggambarkan, menspesifikasikan, serta mendokumentasikan proses yang berlangsung di dalam sistem yang berbasis OOP atau Object Oriented Programming yang akan dibangun.
...
\begin{enumerate}
	...
	\begin{enumerate}[a.]
		...
		\newpage
		\item Halaman Lokasi
		\par Halaman lokasi merupakan halaman dimana admin dapat memilih lokasi dimana aplikasi ini akan tersedia bagi pengguna. Dengan begitu setiap pembeli yang mendaftar hanya dapat memilih alamat sesuai dengan lokasi yang tersedia saja. Halaman lokasi dapat dilihat pada gambar \ref*{lokasi}.
		\begin{figure}[H]
			\centering
			{\includegraphics [width = 13.5cm, height= 8cm]{gambar/admin/lokasi}}
			\caption{Halaman Lokasi}
			\label{lokasi}
		\end{figure}
	\end{enumerate}
	...
	\begin{enumerate}[a.]
		...
		\begin{figure}[H]
			\centering
			{\includegraphics [width = 13.5cm, height= 8cm]{gambar/penjual/pdf_penjual}}
		...
		\begin{figure}[H]
			\centering
			{\includegraphics [width = 13.5cm, height= 8cm]{gambar/penjual/ulasan}}
